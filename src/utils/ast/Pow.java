...
public class Pow extends BinaryOperation {
	...
	public Operation getDerivative() {
		var firstTerm = new Pow(left, right);
		var secondTerm = new Product(right.getDerivative(), new Log(left));
		var thirdTerm = new Division(new Product(right, left.getDerivative()), left);
		return new Product(firstTerm, new Addition(secondTerm,thirdTerm));
	}
}
