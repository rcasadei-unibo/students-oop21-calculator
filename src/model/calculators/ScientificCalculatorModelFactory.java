...
public final class ScientificCalculatorModelFactory {
    ...
    public static CalculatorModel create() {
        final Map<String, CCBinaryOperator> binaryOpMap = Map.of("log", new CCBinaryOperator((n, b) -> Math.log(n) / Math.log(b), 0, null),
                     "nthRoot", new CCBinaryOperator((n, i) -> Math.pow(n, 1 / i), 0, null),
                     "potenza", new CCBinaryOperator((n, e) -> Math.pow(n, e), 0, null));
        final Map<String, CCUnaryOperator> unaryOpMap = Map.of("ln", new CCUnaryOperator((n) -> Math.log(n), 0, null),
